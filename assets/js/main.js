...
/*==================== SEND MESSAGE ====================*/ 
// Listener to form button and send message to WhatsApp
document.getElementById("send").addEventListener("click", function(event) {
  ...
  let textToSend = `[${name} - ${email} - ${perihal}] --> ${message}`;
  textToSend = textToSend.replace(/\s+/g, "%20");

  // Set your WhatsApp number
  const PHONE_NUMBER = "628981708215";
  ...
  document.querySelector(".perihal").value = "";
